...
namespace LevelGen.V2
{
    ...
    /// <c>Assets/Prefabs/Level Prefabs/Rooms/{Category}/</c> and
    /// <c>Assets/Prefabs/Level Prefabs/Halls/{Size}/</c>,
    /// filtered to those with a <see cref="RoomPiece"/> component on the root.
    /// </summary>
    public static class V2PrefabSource
    {
        /// <summary>Returns all room prefabs under <c>Assets/Prefabs/Level Prefabs/Rooms/{category}/</c>.</summary>
        public static List<GameObject> GetRoomPrefabs(RoomCategory category) =>
            GetPrefabsAt($"Assets/Prefabs/Level Prefabs/Rooms/{category}");

        /// <summary>Returns all hall prefabs under <c>Assets/Prefabs/Level Prefabs/Halls/{size}/</c>.</summary>
        public static List<GameObject> GetHallPrefabs(HallCategory size) =>
            GetPrefabsAt($"Assets/Prefabs/Level Prefabs/Halls/{size}");
